...
export const AppConstants = {
    ...
    ApiUrls: {
        ...
        GENERIC_PAYROLL_COMPONENT_URL: 'api/v1/ClientGenericPayrollComponent',
        COMPANY_OVERVIEW_URL: 'api/v1/ClientCompanyDetail',
        ...
        COMPANY_DETAIL_URL: 'api/v1/ClientCompanyDetail',
        ...
        COMPANY_HOLIDAYS_URL: 'api/v1/ClientCompanyHolidays',
        NOTIFICATION_URL: 'api/v1/ClientNotification',
        EMPLOYEE_ADDITIONAL_REIMBURSEMENT_URL: 'api/v1/ClientEmployeeAdditionalReimbursementLogs'
    },
