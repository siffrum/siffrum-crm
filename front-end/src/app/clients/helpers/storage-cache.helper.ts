...
import { AdditionalRequestDetails } from '../../internal-models/additional-request-details';
import { Method } from 'axios';
import { StorageService } from 'src/app/services/storage.service';
import { CacheItem } from 'src/app/internal-models/cache-item';
...
export class StorageCache {//dont extend from base
    ...
    private SaveOrUpdateMapInDb = async (cacheMap: Map<string, CacheItem>): Promise<boolean> => {
        ...
        await this.storageService.setToStorage(AppConstants.DbKeys.API_RESP_CACHE, cacheMapTxt);
        return true;
    }
}
